# Copyright (C) 2009-2019  PISM authors
...
export SIXTEENKMGRID="-Mx 381 -My 381 -Lz 6000 -Lbz 2000 -Mz 81 -Mbz 21"
...
export atm_opts="-atmosphere pik_temp,delta_T,paleo_precip,lapse_rate -temp_era_interim_lon \
...
pico_opts="-gamma_T 1.0e-5 -overturning_coeff 0.8e6 -exclude_icerises \
           -number_of_basins 20 -continental_shelf_depth -2500"
...
###### ice physics
export tillphi_param="-topg_to_phi 5.0,45.0,-500.0,1000.0"
...
export stress_opts="$stress_sia_opts -stress_balance ssa+sia -ssa_method fd \
             -ssa_flow_law gpbld -ssa_e 0.6 $basal_opts"

###### technical
export config_opts="-config_override ${paramfile}.nc"

export tech_opts="-options_left -verbose 2 -o_order zyx -o_size medium -backup_interval 3.0"
